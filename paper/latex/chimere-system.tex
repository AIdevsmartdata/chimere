...
KTransformers~(2024) addresses MoE offloading with CPU expert scheduling. DeepSeek Engram~(arXiv:2601.07372) introduces conditional memory for MoE. Autoresearch~(Karpathy, 2025) proposes self-improving research agents. DFlash~(arXiv:2602.06036) introduces block diffusion drafting. Our system integrates ideas from all of these into a coherent, deployable system on consumer hardware.
