...
The file `docker/config/soul/SOUL.md` defines the model's personality, tone,
and behavioral guidelines. Edit it to customize who the model is.
...
docker/
  ...
  config/
    ...
    pipelines/             ODO routing pipeline YAMLs
  inference/
...
- **HuggingFace models**: [Qwen3.5-35B-A3B RAMP-v2](https://huggingface.co/AIdevsmartdata/Qwen3.5-35B-A3B-RAMP-v2-15g)
